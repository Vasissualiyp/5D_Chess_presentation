...
class Presentation1(ThreeDSlide):
    def construct(self):
        ...
        print(f"Scene object count before assembly: {len(self.mobjects)}")
        board_5d.assemble_the_cube(0.05, orientation=2)
        print(f"Scene object count after assembly: {len(self.mobjects)}")
        self.next_slide()
        board_5d.disassemble_the_cube()
        print(f"Scene object count after disassembly: {len(self.mobjects)}")
