...
#PRESENTATION_NAME="PresentationSlidesAll"
...
manim-slides render -ql $SLIDES_FILE $PRESENTATION_NAME --disable_caching --preview_command vlc # 1&>manim_log.out 2&>manim_log.err #--disable_caching
